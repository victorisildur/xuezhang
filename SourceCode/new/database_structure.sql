...
CREATE TABLE `shop_goods_detail` (
	...
	`color` smallint(4)  NOT NULL default 0,
	`size` smallint(4)  NOT NULL default 3,
...
CREATE TABLE `shop_orders` (
	...
	KEY `shop_goods_detail` (`detail_id`)
)  TYPE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1;
...
CREATE TABLE `shop_order_status` (
	...
	`best_time` smallint(6)  NOT NULL default 6,
